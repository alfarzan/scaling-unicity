...
This script runs the unicity model on functions with a wide range of input distribution parameters. 
The results of the sensitivity analysis in the publication are from here. 
